...
export default function Signup() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView
        className="flex-1 pt-10 px-5"
        showsVerticalScrollIndicator={false}
      >
        <TouchableOpacity onPress={handleGoBack}>
          <Image source={icons.arrowleft} className="h-[15px] w-[18px] mb-5" />
        </TouchableOpacity>
        <Text className="text-[24px] font-poppins-semibold">
          Create Account
        </Text>
        ...
        <View className="flex-row justify-between items-center mb-5">
          <View className="h-[4px] w-[20%] bg-[#ededed] rounded-full" />
          <View className="h-[4px] w-[20%] bg-[#ededed] rounded-full" />
          <View className="h-[4px] w-[20%] bg-[#ededed] rounded-full" />
          <View className="h-[4px] w-[20%] bg-[#ededed] rounded-full" />
        </View>
        {/* privacy and policy */}
        <View className="flex-row items-start mb-12 mt-2">
